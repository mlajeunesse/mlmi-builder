        ...
        'wpml_cf_preferences' => 3,
            ...
            'wpml_cf_preferences' => 3,
  					...
  					'wrapper' => [
  						...
  						'class' => '',
  						'id' => '',
              'title' => __('Propriété: margin-top (bureau)', 'mlmi-builder'),
  					],
  					'choices' => $spacing_options,
  					'default_value' => 'default',
  					'allow_null' => 0,
            ...
            'wpml_cf_preferences' => 3,
  					...
  					'wrapper' => [
  						...
  						'class' => '',
  						'id' => '',
              'title' => __('Propriété: margin-top (mobile)', 'mlmi-builder'),
  					],
  					'choices' => $spacing_options,
  					'default_value' => 'default',
  					'allow_null' => 0,
            ...
            'wpml_cf_preferences' => 3,
  					...
  					'wrapper' => [
  						...
  						'id' => '',
              'title' => __('Propriété: padding-top (bureau)', 'mlmi-builder'),
  					],
  					'choices' => $spacing_options,
  					'default_value' => 'default',
  					'allow_null' => 0,
            ...
            'wpml_cf_preferences' => 3,
  					...
  					'wrapper' => [
  						...
  						'class' => 'no-label',
  						'id' => '',
              'title' => __('Propriété: padding-top (mobile)', 'mlmi-builder'),
  					],
  					'choices' => $spacing_options,
  					'default_value' => 'default',
  					'allow_null' => 0,
            ...
            'wpml_cf_preferences' => 3,
  					...
  					'wrapper' => [
  						...
  						'class' => 'no-label clear-left',
  						'id' => '',
              'title' => __('Propriété: padding-bottom (bureau)', 'mlmi-builder'),
  					],
  					'choices' => $spacing_options,
  					'default_value' => 'default',
  					'allow_null' => 0,
            ...
            'wpml_cf_preferences' => 3,
  					...
  					'wrapper' => [
  						...
  						'class' => 'no-label',
  						'id' => '',
              'title' => __('Propriété: padding-bottom (mobile)', 'mlmi-builder'),
  					],
  					'choices' => $spacing_options,
  					'default_value' => 'default',
  					'allow_null' => 0,
            ...
            'wpml_cf_preferences' => 3,
  					...
  					'wrapper' => [
  						...
  						'class' => 'no-label clear-left',
  						'id' => '',
              'title' => __('Propriété: margin-bottom (bureau)', 'mlmi-builder'),
  					],
  					'choices' => $spacing_options,
  					'default_value' => 'default',
  					'allow_null' => 0,
            ...
            'wpml_cf_preferences' => 3,
  					...
  					'wrapper' => [
  						...
  						'class' => 'no-label',
  						'id' => '',
              'title' => __('Propriété: margin-bottom (mobile)', 'mlmi-builder'),
  					],
  					'choices' => $spacing_options,
  					'default_value' => 'default',
  					'allow_null' => 0,
